...
\begin{itemize}
\item $d(p,q)\geq 0$ og $d(p,q)=0$ hvis og kun hvis $p=q$. Alle afstande er positive. Med ord: Afstanden fra et punkt til sig selv er $0$ og ingen andre afstande er $0$
\item $d(p,q)=d(q,p)$ Afstanden er \emph{symmetrisk}. Med ord: Der er lige så langt fra $p$ til $q$ som fra $q$ til $p$.
\item $d(p,q)+d(q,r)\geq d(p,r)$. \emph{Trekantsuligheden}. Med ord:  Der er mindst lige så langt fra $p$ til $ r$ via $q$, som den direkte afstand fra $p$ til $r$. 
\end{itemize}
\end{tcolorbox}
...
Det er ret nemt at acceptere, at de tre krav er rimelige. Men er det nok? Og hvad med symmetrien? Der er vel længere 10 km op ad bakke end 10 km ned ad bakke, hvis man tænker på arbejdsindsats. Så måske giver det ikke altid mening? 

Definitionen af metrik som her er den, vi bruger i matematik. Den har vist sig nyttig. Der er en skov af artikler og bøger, hvor man kan se, hvad man ved, når man har en funktion, der er en metrik. 
