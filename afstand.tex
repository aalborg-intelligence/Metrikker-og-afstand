...
\item Hvis $p\neq q$ er $d(p,q)=1$.
\end{itemize}
Det er en metrik - den opfylder definitionen ovenfor. Men det er ikke nogen specielt nyttig metrik. Alle punkter ligger lige tæt på alle andre, så der er ikke ny information - udover, om d to punkter er ens eller ikke.
\end{Eksempel}
\begin{Eksempel} Afstand mellem DNA-strenge. Man ved, at en mutation fra 
\end{Eksempel}
