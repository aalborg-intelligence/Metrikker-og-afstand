...
\end{tabular}
\end{center}
uddrager vi ofte forekommende delmængder

\begin{center}
\begin{tabular}{cc}


\{a\} & i dokument 1,4,6,7 \\
\{b\} & i dokument 2,3,5,7,8 \\
\{c\}& i dokument 1,3,4,6,8\\
\{d\} & i dokument 2,3,4,6,8,9 \\
\{e\} & i dokument 1,2,3,4,5,7,9 \\
\{a,b\} & i dokument 7 \\
\{a,c\} & i dokument 1,4,6 \\
\{a,d\}& i dokument 4,6\\
\{ a,e\}& i dokument 1,4,7\\
\{b,c\} & i dokument 3, 8 \\
\{b,d\}& i dokument 2,3,8 \\
\{b,e\}& i dokument  2,3,5,7\\
\{a,c,d\}& i dokument 4\\
\{a,c,e\}& i dokument 1,4 \\
\{b,c,d\}& i dokument 3\\
\{b,c,e\}& i dokument 3\\
\{b,d,e\}& i dokument 2,3 \\
\{c,d,e\} & i dokument 3,4,9 \\
